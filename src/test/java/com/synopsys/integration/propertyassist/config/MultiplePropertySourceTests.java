...
import com.synopsys.integration.propertyassist.property.types.string.NullableStringProperty;
...
class MultiplePropertySourceTests {
    ...
    public void containsKeysFromBothSources() {
        ...
        final PropertyConfiguration config = configOf(primarySource, secondarySource);
        Assertions.assertEquals(new HashSet<>(Arrays.asList(primaryProperty.getKey(), secondaryProperty.getKey())), config.getKeys());
    }
