...
import static com.synopsys.integration.propertyassist.util.ConfigTestUtils.emptyConfig;
import static com.synopsys.integration.propertyassist.util.ConfigTestUtils.propertySourceOf;
...
public class PropertyConfigurationTest {
    ...
    public void getRaw() {
        ...
        final Map<String, String> propertyMap = mapOf(
    ...
    public void getRawFromKeys() {
        ...
        final Set<String> extraKeys = setOf("unrelated.key");
        ...
        Assertions.assertEquals(emptyMap(), config.getRaw(setOf("unrelated.key")), "The config should not provide any values.");
        Assertions.assertEquals(emptyMap(), config.getRaw(setOf()), "The config should not provide any values.");
    }
    ...
    public void getRawPassthroughMultipleValues() {
        ...
        final Map<String, String> properties = mapOf(Pair.of("one", "one value"), Pair.of("two", "two value"));
    ...
    public void getRawPassthroughPrimary() {
        ...
        final Map<String, String> properties = mapOf(Pair.of("shared", "primaryValue"));
        Assertions.assertEquals(properties, configuration.getRaw(passthrough));
    }

    @SafeVarargs
    private final Map<String, String> mapOf(Pair<String, String>... elements) {
