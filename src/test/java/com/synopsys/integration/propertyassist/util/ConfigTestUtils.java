 ...
 * under the License.
 */
package com.synopsys.integration.propertyassist.util;
...
public class ConfigTestUtils {
    ...
    public static PropertySource propertySourceOf(@NotNull final String name, @NotNull final Map.Entry<String, String>... properties) {
        return new MapPropertySource(name, Arrays.stream(properties).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue)));
    }
