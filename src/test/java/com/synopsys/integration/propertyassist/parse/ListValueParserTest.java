 ...
 * under the License.
 */
package com.synopsys.integration.propertyassist.parse;
...
class ListValueParserTest {
    ...
    public void parseDefault() throws ValueParseException {
        ...
        Assertions.assertEquals(Arrays.asList("test", "this", "example", "parser"), actualValues, "The list parser should be splitting on comma and trimming by default.");
    }
    ...
    public void parseCustomDelimiters() throws ValueParseException {
        ...
        Assertions.assertEquals(Arrays.asList("test this", "parser", "for real"), actualValues);
    }
