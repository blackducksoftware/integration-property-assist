...
public class ExtendedEnumPropertiesTests {
    ...
    public void testList() throws InvalidPropertyException {
        final List<ExtendedEnumValue<ExampleExtension, Example>> defaultValue = Arrays.asList(ExtendedEnumValue.ofBaseValue(Example.THING), ExtendedEnumValue.ofExtendedValue(ExampleExtension.NONE));
        ...
        Assertions.assertEquals(Arrays.asList(ExtendedEnumValue.ofBaseValue(Example.THIRD), ExtendedEnumValue.ofExtendedValue(ExampleExtension.NONE)), value);

        PropertyTestHelpUtil.assertAllListHelpValid(property, Arrays.asList("THING", "ANOTHER", "THIRD", "NONE"));
    }
}